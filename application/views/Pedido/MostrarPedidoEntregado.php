        ...
        <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tabla de Pedidos Entregados/No Entregados</h4>
...
<table id="myTable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php $indice=1;  foreach ($Pedidos->result() as $row) { 
                        ...
                        <td><?php echo $row->FechaPedido?></td>
                         ...
                         <td>
                         <form id="Aceptar<?php echo $row->idDetallePedido; ?>" action="<?php echo base_url();?>index.php/Pedidos/ProductoEntregado" method="post" enctype="multipart/form-data">
                        <button  class="btn btn-success" type="button" data-toggle="modal" data-target="#AcepPedido<?php echo $row->idDetallePedido; ?>">Entregado</button>
...
<div class="modal fade" id="AcepPedido<?php echo $row->idDetallePedido; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" form="Aceptar<?php echo $row->idDetallePedido; ?>">Aceptar Pedido</button>
                        ...
                        <td>
                        <form id="Eliminar<?php echo $row->idDetallePedido; ?>" action="<?php echo base_url();?>index.php/Pedidos/ProductoNoEntregado" method="post" enctype="multipart/form-data">
                        
                        <button  class="btn btn-danger" type="button" data-toggle="modal" data-target="#CancelarPedidos<?php echo $row->idDetallePedido; ?>">No Entregado</button>
                        <input type="hidden" name="idPedido" value="<?php echo $row->idDetallePedido; ?>"></input>
                        </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      Estas seguro de que no se Entrego el Pedido?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
