...
<div id="Fecha" style="display:none;">
 <form name="myForm" onsubmit="return validarFechas()" action="<?php echo base_url();?>index.php/Reportes/MostrarEstadisticaPorFechaCliente"  method="post" enctype="multipart/form-data">
  ...
  <form name="myForm" onsubmit="return validarFechas()" action="<?php echo base_url();?>index.php/Reportes/MostrarEstadisticaPorMesCliente"  method="post" enctype="multipart/form-data">
