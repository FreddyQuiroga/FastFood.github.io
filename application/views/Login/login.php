...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<form action="<?=base_url()?>index.php/Welcome/validarUsuario" method="post"  class="login100-form validate-form">
					<span class="login100-form-title p-b-34">
						Iniciar Sesion
					</span>
					
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type user name">
						<input id="first-name" autocomplete="off" class="input100" type="text" name="login" placeholder="User name">
				...
				<div class="login100-more" style="background-image: url('<?php echo base_url(); ?>images/login.jpg');"></div>
			</div>
		</div>
	</div>
